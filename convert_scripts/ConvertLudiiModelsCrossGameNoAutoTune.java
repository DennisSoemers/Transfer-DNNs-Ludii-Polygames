 ...
 * different Ludii games (NOT for zero-shot evaluations, allow subsequent training).
 * 
 * On FAIR cluster, compile (from local_scripts as working directory) using:
 * 	javac -cp /private/home/dennissoemers/Polygames/ludii/Ludii.jar ./ConvertLudiiModelsCrossGameNoAutoTune.java
 * 
 * From the Polygames dir, run using:
 * 	java -cp /private/home/dennissoemers/Polygames/ludii/Ludii.jar:/private/home/dennissoemers/local_scripts ConvertLudiiModelsCrossGameNoAutoTune
 *
 * @author Dennis Soemers
 */
public class ConvertLudiiModelsCrossGameNoAutoTune
{
					...
					for (final GameData targetGame : gameCombination)
					{
						...
						for (int j = 0; j < numTargetOptions; ++j)
						{
							final String outFile = StringRoutines.join("/", 
									"/checkpoint/dennissoemers/crossgame/trainable_no_autotune",
