 ...
 * 	javac -cp /private/home/dennissoemers/Polygames/ludii/Ludii.jar ./ConvertLudiiModelsCrossGameAutoTune.java
 * 
 * From the Polygames dir, run using:
 * 	java -cp /private/home/dennissoemers/Polygames/ludii/Ludii.jar:/private/home/dennissoemers/local_scripts ConvertLudiiModelsCrossGameAutoTune
 *
 * @author Dennis Soemers
 */
public class ConvertLudiiModelsCrossGameAutoTune
{
					...
					for (final GameData targetGame : gameCombination)
					{
						...
						for (int j = 0; j < numTargetOptions; ++j)
						{
							final String outFile = StringRoutines.join("/", 
									"/checkpoint/dennissoemers/crossgame/trainable_autotune",
